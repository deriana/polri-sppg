...
export const laporanList: LaporanProduksi[] = [
  ...
  },
  {
    ...
    foto: [
      {
        id: 'FOTO-007',
        uri: SPPG_ASSET_MAP.lh04_ayam_goreng,
        timestamp: '2026-08-09 08:00',
        lat: -6.9147,
        lng: 107.6098,
        caption: 'Dokumentasi pemorsian Ikan Kakap Goreng Tepung',
      },
    ],
    status: 'diverifikasi',
    dibuatOleh: 'USR-004',
  ...
  },
  {
    ...
    targetPorsi: 1500,
    realisasiPorsi: 1500,
    menu: 'Nasi Liwet Pulen + Ayam Bakar Bumbu Madu + Tumis Kangkung + Pisang Ambon + Susu UHT',
    kategoriGizi: 'Karbohidrat Kompleks, Protein Hewani, Serat & Buah, Kalsium Susu',
    foto: [
      {
        id: 'FOTO-008',
        uri: SPPG_ASSET_MAP.paket_nasi_liwet,
        timestamp: '2026-08-10 07:50',
        lat: -6.9147,
        lng: 107.6098,
        caption: 'Pemorsian tertib Nasi Ayam Bakar Madu',
      },
    ],
    status: 'diverifikasi',
    dibuatOleh: 'USR-002',
  ...
  },
  {
    ...
    targetPorsi: 1500,
    realisasiPorsi: 1500,
    menu: 'Nasi Bento Jepang + Chicken Katsu Saus Teriyaki + Salad Wortel Jagung + Apel Fuji',
    kategoriGizi: 'Karbohidrat, Protein Katsu Crispy, Antioksidan Apel, Vitamin Sayur',
    foto: [
      {
        id: 'FOTO-009',
        uri: SPPG_ASSET_MAP.paket_nasi_ayam_goreng,
        timestamp: '2026-08-11 07:45',
        lat: -6.9147,
        lng: 107.6098,
        caption: 'Penataan ompreng Chicken Katsu Teriyaki',
      },
    ],
    status: 'diverifikasi',
    dibuatOleh: 'USR-002',
  ...
  },
  {
    ...
    targetPorsi: 1500,
    realisasiPorsi: 1485,
    menu: 'Nasi Merah Organik + Ayam Ungkep Kalasan + Sup Kimlo Jamur + Buah Naga',
    ...
    foto: [
      {
        ...
        lat: -6.9147,
        lng: 107.6098,
        caption: 'Uji suhu holding Sup Kimlo & Ayam Kalasan',
      },
    ],
    status: 'diverifikasi',
    dibuatOleh: 'USR-002',
  ...
  },
  {
    ...
    targetPorsi: 1500,
    realisasiPorsi: 1500,
    menu: 'Nasi Kuning Gurih + Daging Rendang Empuk + Sup Sayur Wortel Bening + Jeruk Manis',
    kategoriGizi: 'Karbohidrat, Protein Hewani Tinggi, Mineral & Vitamin C',
    foto: [
      {
        id: 'FOTO-011',
        uri: SPPG_ASSET_MAP.paket_nasi_kuning,
        timestamp: '2026-08-13 07:40',
        lat: -6.9147,
        lng: 107.6098,
        caption: 'Distribusi rendang empuk porsi anak sekolah',
      },
    ],
    status: 'diverifikasi',
    dibuatOleh: 'USR-002',
  ...
  },
  {
    ...
    targetPorsi: 1500,
    realisasiPorsi: 1490,
    menu: 'Nasi Putih Organik + Fillet Ikan Gurame Bakar Kecap + Tumis Buncis Jagung + Semangka Segar',
    kategoriGizi: 'Karbohidrat, Omega-3 Ikan, Serat Buncis, Hidrasi Semangka',
    foto: [
      {
        id: 'FOTO-012',
        uri: SPPG_ASSET_MAP.paket_nasi_gurame,
        timestamp: '2026-08-14 07:55',
        lat: -6.9147,
        lng: 107.6098,
        caption: 'Packing ompreng stainless Ikan Gurame',
      },
    ],
    status: 'diverifikasi',
    dibuatOleh: 'USR-002',
  ...
  },
  {
    ...
    targetPorsi: 1500,
    realisasiPorsi: 1500,
    menu: 'Nasi Pulen + Ayam Kecap Gurih + Sayur Sop Segar + Buah Semangka + Susu UHT',
    kategoriGizi: 'Karbohidrat Kompleks, Protein Hewani, Serat Sayur Sop, Hidrasi Semangka & Kalsium',
    foto: [
      {
        id: 'FOTO-013',
        uri: SPPG_ASSET_MAP.lh04_ayam_goreng,
        ...
        lat: -6.9147,
        lng: 107.6098,
        caption: 'Batch 1 & 2 selesai masak dan diverifikasi lolos QC 84.5°C',
      },
    ],
    status: 'diverifikasi',
    dibuatOleh: 'USR-002',
    ...
    preparationTimestamp: '05:00',
    cookingTimestamp: '06:15',
    qcTimestamp: '07:25',
