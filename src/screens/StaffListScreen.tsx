    ...
    <ScrollView style={[styles.screen, { backgroundColor: colors.background }]} contentContainerStyle={styles.content}>
      ...
      {filteredStaff.length === 0 ? (
        ...
        filteredStaff.map((u) => {
          ...
          return (
            <Card key={u.id} style={[styles.rowCard, { ...shadow.card, borderRadius: radius.lg }]} onPress={() => setSelectedStaff(u)}>
                ...
                <View style={{ flex: 1, gap: 3 }}>
                  ...
                  <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
                    <View style={{ flexDirection: 'row', alignItems: 'center', gap: 6, flex: 1 }}>
                      <Text style={[styles.name, { color: colors.text, fontSize: fontSize.sm, fontWeight: '800' }]} numberOfLines={1}>
                        {u.nama}
                      </Text>
                      {isMe && (
                  ...
                  {/* Role & Division */}
                  <Text style={{ color: colors.accent || colors.primary, fontSize: fontSize.xs, fontWeight: '800' }}>
