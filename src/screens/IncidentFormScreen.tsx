...
const KATEGORI_OPTIONS: Array<{ label: string; value: IncidentCategory }> = [
...
const SEVERITY_OPTIONS: Array<{ label: string; value: IncidentSeverity; color: string; desc: string }> = [
