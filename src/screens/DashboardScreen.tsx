  ...
  const roleSpecificTasks = useMemo(() => {
    ...
    if (role === 'PEMORSI_PACKING') {
      return [
        ...
        {
          id: 'pp_box',
          title: '5. Susun ke Insulated Thermal Box (>60°C)',
          desc: 'Pastikan wadah thermal tertutup rapat menahan panas',
          status: '50 Box Siap Muat',
          tone: 'success' as const,
          isDone: true,
          icon: 'box' as const,
          onPress: () => navigation.navigate('Peralatan'),
    ...
    if (role === 'PETUGAS_LOGISTIK') {
      return [
        ...
        {
          id: 'pl_terima',
          title: '2. Penerimaan Pasokan Bahan (Scan QR DO)',
        ...
        {
          id: 'pl_fefo',
          title: '3. Sortir & Penataan Bahan Sistem FEFO',
        ...
        {
          id: 'pl_suhu',
          title: '4. Monitoring Suhu Sensor IoT Gudang Dingin',
          desc: 'Pantau suhu chiller (0-4°C) dan deep freezer (-18°C)',
        ...
        {
          id: 'pl_mutasi',
          title: '5. Catat Mutasi Pengeluaran Bahan untuk Dapur',
    ...
    if (role === 'PETUGAS_SANITASI') {
      return [
        ...
        {
          id: 'ps_limbah',
          title: '5. Pembersihan Saluran Grease Trap & Limbah Organik',
          desc: 'Pembersihan perangkap lemak dan pembuangan sisa bahan',
          status: 'Limbah Terkendali',
          tone: 'primary' as const,
          isDone: true,
      ...
      return [
        {
          key: 'produksi',
          icon: 'layers',
          title: 'Laporan Masak Batch',
          subtitle: '5 tahap & rasa QC',
          badge: '5 Tahap',
          tone: 'warning',
          onPress: () => navigation.navigate('ProduksiList'),
        },
        {
          key: 'master_menu',
          icon: 'book-open',
          title: 'Resep Bumbu Dapur',
          subtitle: 'Standar gramasi masakan',
          badge: 'Resep SOP',
          tone: 'primary',
          onPress: () => navigation.navigate('MasterMenu'),
        },
        {
          key: 'checklist',
          icon: 'check-square',
          title: 'Kesiapan Dapur',
          subtitle: 'Kompor, wajan, & alat',
          badge: 'Kesiapan',
          tone: 'info',
          onPress: () => navigation.navigate('Checklist'),
        },
        {
          key: 'gudang',
          icon: 'package',
          title: 'Cek Stok Gudang',
          subtitle: 'Bahan masak tersedia',
          badge: 'Bahan Baku',
          tone: 'primary',
          onPress: () => navigation.navigate('Gudang'),
        },
      ...
      return [
        {
          key: 'checklist',
          icon: 'check-square',
          title: 'Checklist Ompreng',
          subtitle: 'Gramasi & seal tutup',
          badge: 'Porsi',
          tone: 'primary',
          onPress: () => navigation.navigate('Checklist'),
        },
        {
          key: 'peralatan',
          icon: 'box',
          title: 'Wadah & Thermal Box',
          subtitle: 'Suhu holding min 60°C',
          badge: 'Alat',
          tone: 'info',
          onPress: () => navigation.navigate('Peralatan'),
        },
      ...
      return [
        {
          key: 'checklist',
          icon: 'shield',
          title: 'Checklist Sanitasi & APD',
          subtitle: 'Kebersihan alat & ruang',
          badge: 'Sanitasi',
          tone: 'success',
          onPress: () => navigation.navigate('Checklist'),
        },
        ...
        },
        {
          key: 'higiene',
          icon: 'thermometer',
          title: 'Inspeksi Dapur',
          subtitle: 'Grease trap & limbah',
          badge: 'Higiene',
          tone: 'info',
          onPress: () => navigation.navigate('FoodSafetyForm'),
        },
