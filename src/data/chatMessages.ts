...
export const chatMessages: ChatMessage[] = [
  { id: 'CHT-001', sppgId: 'SPPG-001', sender: 'command_center', senderName: 'Command Center Polda Jabar', text: 'Selamat pagi, mohon update kesiapan distribusi hari ini.', timestamp: '2026-08-09 06:00' },
  { id: 'CHT-002', sppgId: 'SPPG-001', sender: 'sppg', senderName: 'Kompol Ahmad Fauzi', text: 'Siap, produksi sudah berjalan sesuai target.', timestamp: '2026-08-09 06:05' },
  { id: 'CHT-003', sppgId: 'SPPG-001', sender: 'command_center', senderName: 'Command Center Polda Jabar', text: 'Baik, laporkan segera bila ada kendala di lapangan.', timestamp: '2026-08-09 06:07' },
